                ...
                <div class="card-body">
                        ...
                        <div class="col ">
                            <div class="d-flex align-items-center">
                                <div class="position-relative div-product-image">
                                    <img src="{{".".Storage::url($flashsale->image)}}" alt="post" class="img-fluid rounded">
                                </div>
                                <div class="ms-3"> 
                                    <p class="m-0 mb-1 fs-3 fw-bold">{{ $flashsale->title }}</p>
                                    <span class="badge bg-primary-subtle text-primary">{{ date('d/m/Y', strtotime($flashsale->created_at)) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="mt-3">
                        <div class="text-body mb-1">
                            ...
                            <span>{!! $flashsale->content ? $flashsale->content : "<p>Sản phẩm chưa có mô tả ngắn</p>" !!}</span>
                        </div>                                                            
                    </div>
                </div>
            </div>                             
                                ...
                                <div class="card-body p-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 text-truncate"> 
                                            ...
                                            <h3 class="mt-1 mb-0 fs11 fw-bold text-primary">{{ $flashsale->comments_count }}</h3>                                                                                                                                   
                                        </div>
                                    </div>
                                </div>
                            </div>                     
                                ...
                                <div class="card-body p-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 text-truncate"> 
                                            ...
                                            <h3 class="mt-1 mb-0 fs11 fw-bold text-info">{{ $flashsale->views }}</h3>                                                                                                                                   
                                        </div>
                                    </div>
                                </div>
                            </div>                     
                ...
                <div class="card-body">
                    <div class="product-comments">
                        ...
                        <div class="comments-list">
                            @if ($flashsale->comments->isEmpty())
                                <p>Chưa có bình luận nào cho bài viết này.</p>
                            @else
                                @foreach ($flashsale->comments as $comment)
