<div class="container-xxl animated fadeInDown">
    ...
    <form id="myForm" action="{{route('post.update', $flashsale->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('put')
    <div class="row justify-content-center">
        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control {{$errors->has("title") ? "is-invalid" : ""}}" name="title" value="{{old('title', $flashsale->title)}}" type="text" placeholder="Nhập vào tiêu đề">
                                    @if ($errors->has("title"))
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div id="editor">{!! old('content',  $flashsale->content) !!}</div>
                                    <!-- Textarea ẩn -->
                                    <textarea name="content" class="form-control" style="display: none">{!! old('content', $flashsale->content) !!}</textarea>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <div class="position-relative">
                                        ...
                                        <img src="{{".".Storage::url($flashsale->image)}}" class="image-style position-absolute" style="display: block" id="image" alt="image">
                                    </div>
                                    @if ($errors->has("image"))
