            ...
            <div id="slider" class="nivoSlider">
              <a href="shop.html"
                ><img
                  ...
                  data-thumb="templates/img/slider/1.jpg"
                  alt=""
                  title="#htmlcaption"
              /></a>
              <a href="shop.html"
                ><img
                  ...
                  data-thumb="templates/img/slider/2.jpg"
                  alt=""
                  title="#htmlcaption2"
              /></a>
            </div>
          ...
          <div class="main-hot-deal">
            ...
            <div class="hot-deal-active owl-carousel">
              ...
              <div class="single-product">
                  <!-- Product Image Start -->
                  <div class="pro-img w-100 d-flex align-items-center" style="aspect-ratio: 1/1">
                      <a href="{{ route('client.product.detail', $flashSaleProduct->id) }}">
                          <img class="primary-img" src="{{ '.' . Storage::url($flashSaleProduct->image) }}" alt="single-product" />
                      </a>
                      <div class="countdown bg-main text-white" data-countdown="{{ $flashSaleProduct->flashSales->first()->end_time }}"></div>
                  </div>
                  <!-- Product Image End -->
                  <!-- Product Content Start -->
                  <div class="pro-content">
                      <div class="pro-info">
                          <h4><a href="{{ route('client.product.detail', $flashSaleProduct->id) }}">{{ $flashSaleProduct->name }}</a></h4>
                          <div class="product-rating">
                              <i class="fa fa-star"></i>
                              <i class="fa fa-star"></i>
                              <i class="fa fa-star"></i>
                          ...
                          <p>
                              <span class="price" style="font-size: 14px">{{ number_format($flashSaleProduct->flashSales->first()->flash_sale_price, 0, '', '.') }}đ</span>
                          </p>
                      </div>
                      <div class="pro-actions">
                          <div class="actions-primary">
                              <a href="{{ route('client.product.detail', $flashSaleProduct->id) }}" class="px-1 mx-2" data-bs-toggle="tooltip" data-bs-placement="top" title="Xem chi tiết">Xem chi tiết</a>
                          </div>
                          <div class="actions-secondary">
                              <form action="{{ route('client.wishlist.add', $flashSaleProduct->id) }}" method="POST" style="display: inline;">
                                  @csrf
                                  <button type="submit" data-bs-toggle="tooltip" class="whish-btn" data-bs-placement="top" title="Yêu thích">
                                      <i class="fa fa-heart-o" style="font-size: 20px;"></i>
                                  </button>
        ...
        <div class="col-lg-6">
          ...
          <div class="main-pro-wrapper">
            <div class="new-products">
              ...
              <div class="single-banner">
                <a href="shop.html"
                  ><img src="templates/img/banner/11.jpg" alt=""
                /></a>
              </div>
            </div>
        ...
        <div class="col-lg-6">
          ...
          <div class="main-pro-wrapper">
            <div class="featured-products">
              ...
              <div class="single-banner">
                <a href="shop.html"
                  ><img src="templates/img/banner/12.jpg" alt=""
                /></a>
              </div>
            </div>
