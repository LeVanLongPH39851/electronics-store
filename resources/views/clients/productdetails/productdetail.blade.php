                                ...
                                @else
                                    @foreach ($product->reviews as $review)
                                        <div class="review-item">
                                            <div class="row">
                                                <div class="col-1">
                                                    <img src="https://png.pngtree.com/png-clipart/20190904/original/pngtree-user-cartoon-avatar-pattern-flat-avatar-png-image_4492883.jpg"
                    ...
                    <div class="pro-content">
                        ...
                        <div class="pro-actions">
                            <div class="actions-primary">
                                <a href="{{ route('client.product.detail', $relatedProduct->id) }}" class="px-1"
