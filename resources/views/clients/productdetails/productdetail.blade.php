                ...
                <div class="col-lg-5 mb-all-40">
                    ...
                    <div class="tab-content">
                        <div id="thumb1" class="tab-pane fade show active">
                            <a data-fancybox="images" href="templates/img/products/35.jpg"><img src="templates/img/products/35.jpg" alt="product-view"></a>
                        </div>
                        <div id="thumb2" class="tab-pane fade">
                            <a data-fancybox="images" href="templates/img/products/13.jpg"><img src="templates/img/products/13.jpg" alt="product-view"></a>
                        </div>
                        <div id="thumb3" class="tab-pane fade">
                            <a data-fancybox="images" href="templates/img/products/15.jpg"><img src="templates/img/products/15.jpg" alt="product-view"></a>
                        </div>
                        <div id="thumb4" class="tab-pane fade">
                            <a data-fancybox="images" href="templates/img/products/4.jpg"><img src="templates/img/products/4.jpg" alt="product-view"></a>
                        </div>
                        <div id="thumb5" class="tab-pane fade">
                            <a data-fancybox="images" href="templates/img/products/5.jpg"><img src="templates/img/products/5.jpg" alt="product-view"></a>
                        </div>
                    </div>
                    ...
                    <div class="product-thumbnail">
                        <div class="thumb-menu owl-carousel nav tabs-area" role="tablist">
                            <a class="active" data-bs-toggle="tab" href="#thumb1"><img src="templates/img/products/35.jpg" alt="product-thumbnail"></a>
                            <a data-bs-toggle="tab" href="#thumb2"><img src="templates/img/products/13.jpg" alt="product-thumbnail"></a>
                            <a data-bs-toggle="tab" href="#thumb3"><img src="templates/img/products/15.jpg" alt="product-thumbnail"></a>
                            <a data-bs-toggle="tab" href="#thumb4"><img src="templates/img/products/4.jpg" alt="product-thumbnail"></a>
                            <a data-bs-toggle="tab" href="#thumb5"><img src="templates/img/products/5.jpg" alt="product-thumbnail"></a>
                        </div>
                    </div>
                    <!-- Thumbnail image end -->
                </div>
       ...
       <!-- Post Title End -->
        ...
        <div class="featured-pro-active owl-carousel">
                ...
                <div class="pro-content">
                    ...
                    <div class="pro-actions">
                        ...
                        <div class="actions-secondary">
                            <a href="#" data-bs-toggle="modal" data-bs-target="#myModal" title="Quick View"><i class="fa fa-heart-o"></i></a>
            ...
            <div class="single-product">
                ...
                <div class="pro-img">
                    <a href="product.html">
                        ...
                        <img class="secondary-img" src="templates/img/products/6.jpg" alt="single-product">
                    </a>
                    <span class="sticker-new">new</span>
                </div>
                <!-- Product Image End -->
            ...
            <div class="single-product">
                ...
                <div class="pro-img">
                    <a href="product.html">
                        <img class="primary-img" src="templates/img/products/34.jpg" alt="single-product">
                        <img class="secondary-img" src="templates/img/products/32.jpg" alt="single-product">
                    </a>
                    <span class="sticker-new">new</span>
                </div>
                <!-- Product Image End -->
            ...
            <div class="single-product">
                ...
                <div class="pro-img">
                    <a href="product.html">
                        ...
                        <img class="secondary-img" src="templates/img/products/9.jpg" alt="single-product">
                    </a>
                    <span class="sticker-new">new</span>
                </div>
                <!-- Product Image End -->
