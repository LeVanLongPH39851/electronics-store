            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-12">
                    <div class="logo mb-all-30">
                        <a href="index.html"><img src="templates/img/logo/logo.png" alt="logo-image" /></a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-12">
                    <div class="cart-box mt-all-30">
                        <ul class="d-flex justify-content-lg-end justify-content-center align-items-center">
                            <li>
                                <a class="wish-list-item" href="wishlist.html"><i
                                        class="ion-android-favorite-outline"></i></a>
                            </li>
                            <li>
                                <a href="{{ route('client.cart') }}"><i class="ion-bag"></i><span class="total-pro">2</span><span
                                ...
                                <ul class="ht-dropdown cart-box-width">
                                    <li>
                                        ...
                                        <div class="single-cart-box">
                                            <div class="cart-img">
                                                <a href="#"><img src="templates/img/products/1.jpg"
                                                        alt="cart-image" /></a>
                                        ...
                                        <div class="single-cart-box">
                                            <div class="cart-img">
                                                <a href="#"><img src="templates/img/products/2.jpg"
                                                        alt="cart-image" /></a>
                                                <span class="pro-quantity">1X</span>
                                            </div>
                                            <div class="cart-content">
